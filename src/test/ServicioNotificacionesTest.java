...
import clases_test.ServicioNotificaciones_Ekaitz;
...
class ServicioNotificacionesTest {
    ...
    private ServicioNotificaciones_Ekaitz servicio;

    @BeforeEach
    void setUp() {
        servicio = new ServicioNotificaciones_Ekaitz(emailSenderMock);
    }
