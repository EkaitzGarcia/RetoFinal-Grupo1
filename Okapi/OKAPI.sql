-- Active: 1773053407278@@127.0.0.1@3306@okapi
...
BEGIN
    ...
    DELETE FROM TMP_PRODUCTOS;

    OPEN C;
    FETCH C INTO P_REF, P_NOMBRE, P_PRECIO, P_DESCUENTO;
    WHILE FIN = 0 DO
        INSERT INTO TMP_PRODUCTOS VALUES (P_REF, P_NOMBRE, P_PRECIO, P_DESCUENTO);
        FETCH C INTO P_REF, P_NOMBRE, P_PRECIO, P_DESCUENTO;
    END WHILE;
    CLOSE C;

    SELECT REF, NOMBRE, PRECIO, DESCUENTO FROM TMP_PRODUCTOS;

    DROP TEMPORARY TABLE TMP_PRODUCTOS;
END //
...
INSERT INTO
    ESTA (ID, REF, CANTIDAD)
VALUES (7, 'P004', 2), -- 59.99 * 2 = 119.98 antes de descuentos
    (7, 'P005', 1);
-- 39.99 * 1 = 39.99 antes de descuentos
