...
public class Prueba_Vista_Producto extends JDialog implements ActionListener {
    ...
    public static void main(String[] args) {
        try {
            Prueba_Vista_Producto dialog = new Prueba_Vista_Producto(); // CORRECCIÓN: era Vista_Producto
