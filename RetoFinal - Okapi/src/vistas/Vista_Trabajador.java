...
public class Vista_Trabajador extends JDialog {
	...
	private void darAltaCompra() {
		...
		try {
			...
			JOptionPane.showMessageDialog(this,
				"Purchase created with " + productos.size() + " product(s).\nXML updated at: " + XML_AUTO_PATH);
	...
	private void exportarXMLAutomatico() {
		try {
			...
			JOptionPane.showMessageDialog(this, "Warning: could not update XML: " + ex.getMessage());
		}
	}
